...
class SDProvincev2 extends InputWidget {
	...
	$itemsProvince = \backend\modules\addr\classes\AddrQuery::getProvince();
	...
	$html = "<div class='row'><div class='col-md-4'>";
        $html .=  Select2::widget([
            ...
            'data' => ArrayHelper::map($itemsProvince,'id','name'),
            //'model' =>$this->model,
	...
	$html .= "</div>";
		...
		'allowClear' => true,
                ...
                'placeholder'=>'อำเภอ',
                'url'=>Url::to(['/core/province/get-amphur']),
	...
	$html .= "</div>";
		...
		'select2Options'=>['pluginOptions'=>['allowClear'=>true]],
                'pluginOptions'=>[
		    'allowClear' => true,
                    'depends'=>[$this->id.'_'.$fields['province'], $this->id.'_'.$fields['amphur']],
                    'placeholder'=>'ตำบล',
		    'initialize' => true,
		    'initDepends'=>[$this->id.'_'.$fields['province']],
                    'url'=>Url::to(['/core/province/get-tumbon']),
