...
//        }
            if ($insert) {
                if ($this->modelProfile == null) {
                    ...
                    $this->modelProfile->name = $this->username;
                    $this->modelProfile->fname = " ";
                    $this->modelProfile->lname = " ";
                    $this->modelProfile->location = " ";
                    $this->modelProfile->bio = " ";
                    $this->modelProfile->website = " ";
                    $this->modelProfile->dob = " ";
