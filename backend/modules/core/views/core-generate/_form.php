...
<div class="core-generate-form">
	...
	<div class="modal-body">
	    ...
	    <?= Html::activeHiddenInput($model, 'gen_ui')?>
	    
	    <div class="row">
			<div class="col-md-6">
				<?= $form->field($model, 'template_html')->textarea(['rows' => 3, 'placeholder'=>'Template HTML.']) ?>
				<?= $form->field($model, 'template_php')->textarea(['rows' => 3, 'placeholder'=>'Template PHP.']) ?>
			</div>
			<div class="col-md-6 sdbox-col">
				<?= $form->field($model, 'template_js')->textarea(['rows' => 3, 'placeholder'=>'Template JavaScript.']) ?>
				<?= $form->field($model, 'gen_process')->hint('Use <b>$fields</b> set property.')->textarea(['rows' => 3, 'placeholder'=>'PHP Code.']) ?>
			</div>
	    </div>
