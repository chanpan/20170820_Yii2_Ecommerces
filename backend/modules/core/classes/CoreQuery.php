...
class CoreQuery {
	...
	$model = CoreOptions::find()
		...
		->where('option_name LIKE :option_name', [':option_name' => $term . '_%'])
    ...
    public static function getTermTaxonomyById($id) {
	$sql = "SELECT core_terms.term_id, 
				core_terms.`name`, 
				core_terms.slug, 
				core_terms.term_group, 
				...
				core_term_taxonomy.count
			FROM core_terms INNER JOIN core_term_taxonomy ON core_terms.term_id = core_term_taxonomy.term_id
			WHERE core_term_taxonomy.term_taxonomy_id = :id";
	...
	$sql = "SELECT core_terms.term_id, 
				...
				core_term_taxonomy.count
			FROM core_terms INNER JOIN core_term_taxonomy ON core_terms.term_id = core_term_taxonomy.term_id
			WHERE core_term_taxonomy.term_id = :id";
