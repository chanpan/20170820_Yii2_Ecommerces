...
<div class="item-form">
	...
	<div class="row">
            ...
            $dataItemsType = \backend\modules\cases\classes\CaseQuery::getCaseItemsType('item');
            ...
            <div class="col-md-3 "><?= $form->field($model, 'case_items_type_id')->dropDownList(\yii\helpers\ArrayHelper::map($dataItemsType, 'id', 'name')) ?></div>
                <div class="col-md-3 sdbox-col"><?= $form->field($model, 'item_group_id')->dropDownList($taxonomy, ['encode' => false, 'prompt' => 'none', 'data-id'=>$model->id]) ?></div>
