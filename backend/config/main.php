...
return [
    ...
    'modules' => [
        ...
        'cases' => [
            'class' => 'backend\modules\cases\Module',
        ],
        'items' => [
            'class' => 'backend\modules\items\Module',
        ],
        'places' => [
            'class' => 'backend\modules\places\Module',
        ],
        'addr' => [
            'class' => 'backend\modules\addr\Module',
        ],
        'guides' => [

            'class' => 'backend\modules\guides\Module',
    ...
    'components' => [
        'fileStorage' => [
            ...
            'baseUrl' => 'http://storage.dev/source',
            'filesystem' => [
        ...
        'languagepicker' => [
            ...
            'languages' => ['en-US', 'th', 'ja-JP', 'ko'], // List of available languages (icons only)
